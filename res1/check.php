					...
					<div class="mp-level">
						...
						<ul>
							<li class="icon icon-arrow-left">
							    ...
							    <a class="icon icon-display" href="../patient/navigation.php">Home</a>
								<div class="mp-level">
									...
									<ul>
										...
										<li class="icon icon-arrow-left">
											<a class="icon icon-camera" onclick="five();">See your health report</a>
											
										</li>

									</ul>
								</div>
								<a class="icon icon-display" href="logout.php">Log Out</a>
