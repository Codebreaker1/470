					...
					<div class="mp-level">
						...
						<ul>
							<li class="icon icon-arrow-left">
					           ...
					           <a class="icon icon-display" href="../../471/index.html">Home</a>
								...
								<div class="mp-level">
									...
									<ul>
										...
										<li class="icon icon-arrow-left">
											<a class="icon icon-camera" onclick="third();">Who has a particular blood element level</a>
											
										</li>
										<li class="icon icon-arrow-left">
											<a class="icon icon-camera" onclick="four();">Life style factors influencing health conditions</a>
